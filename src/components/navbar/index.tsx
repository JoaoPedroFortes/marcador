...
const navigation = [
  ...
  { name: 'Agendamentos', href: '/agendamento', current: false },
...
export default function Home({ children }) {
  ...
  useEffect(()=>{
    ...
    localStorage.setItem('cookieUser', str)
  ...
  return (
    <>
      <div className="min-h-full">
        <Disclosure as="nav" className="bg-darcula">
          {({ open }) => (
            <>
                        ...
                        <div>
                          <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                            ...
                            {(!!user.imageUrl) ?
                              ...
                              :
                              <span className='text-white font-bold border-white  w-8 rounded-full'>{user.name.substring(0, 1)}</span>
                            }
                          </Menu.Button>
                        </div>
                        <Transition
